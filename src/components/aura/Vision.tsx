    ...
    <section id="vision" aria-labelledby="vision-title" className="section-pad relative">
      ...
      <div className="relative mx-auto grid max-w-6xl gap-12 px-5 lg:grid-cols-2 lg:gap-20">
        <div>
          ...
          <Reveal delay={0.05}>
            <h2 id="vision-title" className="text-3xl leading-[1.05] font-bold sm:text-4xl md:text-5xl">
        ...
        <div className="space-y-5 text-base leading-relaxed text-muted-foreground md:text-lg">
          ...
          <Reveal delay={0.16}>
            <p>
              ...
              entertainment company. What we're building toward is an Indian entertainment
              ecosystem that discovers, develops, and introduces exceptional artists to audiences
              around the world.
            </p>
          </Reveal>
          <Reveal delay={0.22}>

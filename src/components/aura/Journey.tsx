...
const steps = [
  { icon: Search, title: "DISCOVER", copy: "Show your talent to the world." },
  { icon: Handshake, title: "CONNECT", copy: "Meet artists who share your ambition." },
  {
    icon: Sparkles,
    title: "MATCH",
    copy: "Find artists whose style and creative energy complement yours.",
  },
  { icon: Mic, title: "FORM", copy: "Build something bigger together." },
  {
    icon: Rocket,
    title: "DEVELOP",
    copy: "Grow through collaboration, learning, and future mentorship opportunities.",
  },
  { icon: Globe, title: "DEBUT", copy: "Prepare for the world stage." },
];

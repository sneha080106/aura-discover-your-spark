...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* 3D layer */}
      <div
        className="pointer-events-none absolute inset-0 opacity-70 [mask-image:radial-gradient(70%_60%_at_70%_45%,black,transparent)]"
        aria-hidden="true"
      >
        {show3d ? (
      ...
      <div className="relative mx-auto w-full max-w-6xl px-5">
        ...
        >
          ...
          <h1
            id="hero-title"
            className="mt-7 text-4xl leading-[0.95] font-bold sm:text-6xl lg:text-7xl"
          >
            <motion.span
              variants={line}
              transition={{

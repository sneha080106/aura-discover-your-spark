...
const factors = [
  { icon: Music2, label: "Musical style" },
  { icon: Mic2, label: "Vocal strengths" },
  { icon: Star, label: "Performance skills" },
  { icon: Sparkles, label: "Dance ability" },
  { icon: Languages, label: "Languages" },
  { icon: Target, label: "Artistic goals" },
];
    ...
    <section id="vibe-match" aria-labelledby="match-title" className="section-pad relative">
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-14 px-5 lg:grid-cols-2">
        <div>
          ...
          <Reveal delay={0.05}>
            <h2 id="match-title" className="text-3xl leading-tight font-bold sm:text-4xl md:text-5xl">
        ...
        {/* Matching visual */}
        <div className="relative flex items-center justify-center gap-3 sm:gap-6" aria-hidden="true">
